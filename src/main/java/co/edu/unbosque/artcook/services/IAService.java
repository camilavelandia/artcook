...
public class IAService {
    ...
    public String generarRecetaConGPT(String prompt, String tipoReceta, Integer porciones) throws PromptVacioException {
        ...
        try {
            ...
            Map<String, Object> body = Map.of(
                "model", "gpt-4o-mini",
                "messages", List.of(
                    Map.of("role", "user", "content", construirPromptGPT(prompt, tipoReceta, porciones))
                ),
                "max_tokens", 1500
            );
     ...
     * @throws PromptVacioException si el prompt es nulo, vacío o muy corto
     */
    public String generarRecetaConGemini(String prompt, String tipoReceta, Integer porciones) throws PromptVacioException {
        LanzadorExcepciones.validarPrompt(prompt);
        ...
        for (String modelo : modelos) {
            try {
                ...
                Map<String, Object> body = Map.of(
                    "contents", List.of(
                        Map.of("parts", List.of(Map.of("text", construirPromptGemini(prompt, tipoReceta, porciones))))
                    ),
     ...
     * @throws PromptVacioException si el prompt es nulo, vacío o muy corto
     */
    public String generarRecetaConClaude(String prompt, String tipoReceta, Integer porciones) throws PromptVacioException {
        LanzadorExcepciones.validarPrompt(prompt);
        ...
        try {
            ...
            Map<String, Object> body = Map.of(
                ...
                "max_tokens", 1500,
                "messages", List.of(
                    Map.of("role", "user", "content", construirPromptClaude(prompt, tipoReceta, porciones))
                )
            );
    ...
    /**
     * Construye el prompt para OpenAI GPT — chef profesional de gastronomía internacional.
     */
    private String construirPromptGPT(String prompt, String tipoReceta, Integer porciones) {
        return "Eres un chef profesional. El usuario quiere una " + tipoReceta + ". "
            ...
            + "tiempo_preparacion, dificultad, ingredientes con cantidades exactas para " 
            + porciones + " personas, pasos detallados y consejos profesionales. "
            + "Responde siempre en español.\n\nEl usuario pide: " + prompt;
    }
    

    /**
     * Construye el prompt para Claude — nutricionista chef especializado en cocina saludable.
     */
    private String construirPromptClaude(String prompt, String tipoReceta, Integer porciones) {
        return "Eres un nutricionista chef especializado en cocina saludable y un artesano ecologico. "
            ...
            + "Si es RECETA DE COCINA responde en JSON con: tipo, nombre, porciones, tiempo_preparacion, calorias_por_porcion, ingredientes saludables con cantidades para " + porciones + " personas, pasos con tecnicas saludables y beneficios_nutricionales. "
            + "Si es MANUALIDAD responde en JSON con: tipo, nombre, dificultad, tiempo_estimado, materiales reciclados o ecologicos con cantidades, pasos detallados, impacto_ambiental y consejos_sostenibles. "
            + "Ajusta siempre las cantidades segun el numero de personas. Responde siempre en espanol.\n\n"
            + "El usuario pide: " + prompt;
    }

    /**
     * Construye el prompt para Gemini — chef casero experto en recetas rápidas y económicas.
     */
    private String construirPromptGemini(String prompt, String tipoReceta, Integer porciones) {
        return "Eres un chef casero experto en recetas rapidas y economicas, y un experto en manualidades con materiales del hogar. "
            + "Primero detecta si el usuario pide una RECETA DE COCINA, una MANUALIDAD, o algo invalido. "
            + "Si no tiene sentido responde SOLO con: {\"error\": \"Lo que escribiste no corresponde a una receta de cocina ni a una manualidad valida. Por favor intenta de nuevo.\"}. "
            + "Si es RECETA DE COCINA responde en JSON con: tipo, nombre, porciones, tiempo_preparacion, costo_aproximado, ingredientes faciles de conseguir con cantidades para " + porciones + " personas, pasos simplificados y sustituciones. "
