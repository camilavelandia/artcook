...
public class IAController {
    ...
    public ResponseEntity<?> generarConTodasLasIAs(
        ...
        CompletableFuture<String> futuroGPT = CompletableFuture.supplyAsync(() -> {
            try { return iaService.generarRecetaConGPT(prompt, tipo, porcionesFinales); }
            catch (Exception e) {
        ...
        CompletableFuture<String> futuroGemini = CompletableFuture.supplyAsync(() -> {
            try { return iaService.generarRecetaConGemini(prompt, tipo, porcionesFinales); }
            catch (Exception e) {
        ...
        CompletableFuture<String> futuroClaude = CompletableFuture.supplyAsync(() -> {
            try { return iaService.generarRecetaConClaude(prompt, tipo, porcionesFinales); }
            catch (Exception e) {
        ...
        try {
            CompletableFuture.allOf(futuroGPT, futuroGemini, futuroClaude)
