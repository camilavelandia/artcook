...
/**
 * Controlador que gestiona las operaciones relacionadas con las recetas.
 * La generación con IAs se delega al IAController.
 * Este controlador gestiona consultas, selección de IA, actualización y eliminación.
 */
@RestController
...
public class RecetaController {
    ...
    /**
     * Obtiene todas las recetas del sistema. Solo para administradores.
     *
     ...
     * @return datos completos de la receta
     */
    @GetMapping("/porid")
     ...
     *
     * @param tipo tipo de receta (COCINA o MANUALIDAD)
     * @return lista de recetas filtradas por tipo
     */
    @GetMapping("/portipo")
     ...
     * @param ia        nombre de la IA (gpt, gemini, claude)
     * @param usuarioId ID del usuario
    ...
    public ResponseEntity<String> seleccionarReceta(@RequestParam Long recetaId,
        ...
        if (!ia.equalsIgnoreCase("gpt") && !ia.equalsIgnoreCase("gemini")
            ...
            return new ResponseEntity<>("La IA debe ser gpt, gemini o claude.", HttpStatus.BAD_REQUEST);
        }
        ...
        case 2:
            return new ResponseEntity<>("La IA seleccionada no tiene contenido disponible.", HttpStatus.BAD_REQUEST);
        default:
     ...
     * @param jsonRecetaSeleccionada nuevo contenido seleccionado (opcional)
     * @param iaSeleccionada         IA seleccionada (opcional)
     * @param urlVideo               URL del video (opcional)
     * @param urlAudio               URL del audio (opcional)
     * @param guionNaracion          guión de narración (opcional)
    ...
    /**
     * Retorna el total de recetas generadas en el sistema.
     *
     * @return cantidad total de recetas
     */
    @GetMapping("/contar")
    ...
    /**
     * Genera y descarga un PDF con el contenido de la receta seleccionada.
     *
     * @param idReceta  identificador de la receta
     * @param usuarioId ID del usuario que realiza la descarga
     * @param request   petición HTTP para auditoría
     * @return PDF en bytes
     */
