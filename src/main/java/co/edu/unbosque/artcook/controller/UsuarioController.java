 ...
 * Permite registro, login, verificación de correo, recuperación de contraseña y administración.
 */
@RestController
...
public class UsuarioController {
     ...
     * Retorna los datos del usuario para gestionar la sesión en el frontend.
     *
     * @param email      correo electrónico
     * @param contrasena contraseña
     * @param request    petición HTTP para auditoría
    ...
    public ResponseEntity<String> solicitarRecuperacion(@RequestParam String email,
        ...
        case 0:
            ...
            return new ResponseEntity<>(
                    "Se envio un correo con las instrucciones para recuperar tu contrasena.", HttpStatus.OK);
        case 1:
