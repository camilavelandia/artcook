...
/**
 * Clase de configuración para cargar datos iniciales en la base de datos de ArtCook.
 * Crea un usuario administrador predeterminado al iniciar la aplicación si no existe.
 * Esto garantiza que siempre haya al menos un administrador disponible.
 */
@Configuration
public class LoadDatabase {
     ...
     * @param passwordEncoder codificador de contraseñas para encriptar las contraseñas
