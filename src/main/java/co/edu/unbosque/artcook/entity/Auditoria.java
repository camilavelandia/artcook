 ...
 * Guarda quién hizo qué, cuándo y sobre qué entidad.
 */
@Entity
...
public class Auditoria {
    ...
    /**
     * Crea un registro de auditoría con los datos principales.
     *
    ...
    public String toString() {
        return "Auditoria [id=" + id + ", usuarioId=" + usuarioId + ", accion=" + accion
